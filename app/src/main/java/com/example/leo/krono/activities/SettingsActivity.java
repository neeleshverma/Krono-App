 ...
 */
//mostly automatically generated class from template
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || MutePreferenceFragment.class.getName().equals(fragmentName)
                ;
    }
    ...
    public static class AlertPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_minute);
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class MutePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
