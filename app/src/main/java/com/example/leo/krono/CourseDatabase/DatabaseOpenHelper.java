...
public class DatabaseOpenHelper extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "coursedb.db"; //name of database
    private static final int DATABASE_VERSION = 3; //database version, update it when the database is changed otherwise android won't reload it
